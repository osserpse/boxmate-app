    ...
    <div className="min-h-screen bg-gradient-to-br from-lime-50 via-stone-50 to-yellow-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Your local marketplace community</p>
        </div>
        ...
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sign in to access your account and start selling
            </CardDescription>
          </CardHeader>
        ...
        <div className="text-center text-sm text-muted-foreground mt-8">
          <p>Demo login page - Authentication coming soon!</p>
        </div>
      </div>
    </div>
  );
